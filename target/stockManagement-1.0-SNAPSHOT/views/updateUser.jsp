    ...
    <c:forEach var="user" items="${ user }">
        ...
        <div class="modal-body">
            <form class="formUpdateUser" action="userUpdate" method="post">
                ...
                <button type="submit" class="btn btn-outline-info float-right" id="id-valider-updateUser-btn">Valider
                </button>
                <div class="mb-1">
                ...
                <div class="row">
                    <div class="col">
                        <div class="mb-1">
                            ...
                            <input type="text" name="lastNameUpdate" class="form-control lastNameClass"
                                   id="lastNameUpdate"
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="mb-1">
                            ...
                            <input type="Date" name="inscriptionDateUpdate" class="form-control"
                                   id="inscriptionDateUpdate"
    ...
    <div class="d-flex flex-row-reverse float-right">
        <form action="addAdress" method="get" class="selectedUserForm float-right bg-transparent border-0 d-flex ">
            ...
            <input type="text" name="selectedUserUpdate-id" class="form-control p-2" id="selectedUseridUpdate"
                   aria-describedby="selectedUser" hidden>
            <button type="submit" class="btn btn-outline-info float-right p-2 " id="idAddAdress">Ajouter une adresse
            </button>
        </form>
        <form action="UpdateAdress" method="get"
              class="selectedUserForm float-right bg-transparent border-0 d-flex     ">
            ...
            <input type="text" name="user-id" class="form-control p-2" id="user-id"
                   aria-describedby="selectedUser" hidden>
            <button type="submit" disabled class="btn btn-outline-info float-right p-2" id="id-UpdateAdress">Mettre à
                jour
            </button>
        </form>
    </div>
