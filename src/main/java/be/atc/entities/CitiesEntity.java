...
@Entity @Table( name = "cities", schema = "stock-management" )
public class CitiesEntity {
    @Id
    @GeneratedValue( strategy = GenerationType.IDENTITY )
    @Column( name = "id_city", nullable = false )
    private int          idCity;
    @Basic @Column( name = "citie", nullable = false, length = 60 )
    private String       citie;
    @Basic @Column( name = "postalCode", nullable = false )
    ...
    @ManyToOne @JoinColumn( name = "id_country", referencedColumnName = "id_country", nullable = false )
